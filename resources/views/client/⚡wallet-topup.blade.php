...
<div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm max-w-md w-full">
    ...
    <form wire:submit="initiateTopup" class="space-y-5">
        ...
        <button type="submit" disabled="{{ $isProcessing }}" class="w-full py-3 rounded-lg bg-[#25D366] hover:bg-[#20b858] text-slate-900 font-bold text-lg transition shadow-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
