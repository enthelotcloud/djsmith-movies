    ...
    <footer class="relative bg-black border-t border-gray-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="py-8 lg:py-10">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex flex-col items-center md:items-start gap-2">
                        <p class="text-sm text-gray-400">
                            &copy; {{ date('Y') }} Dj Smith Movies. All rights reserved.
                        </p>
                        <p class="text-xs text-gray-500">
                            Developed by
                            <a
                                href="https://enthelotcloud.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                class="text-gray-400 hover:text-red-500 transition-colors duration-200 underline-offset-2 hover:underline"
                            >
                                EnthelotCloud
                            </a>
                        </p>
                ...
                <div class="mt-6 pt-6 border-t border-gray-800/30 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="#" class="text-gray-600 hover:text-gray-400 transition-colors duration-200">
